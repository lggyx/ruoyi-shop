    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['shop:supplier:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['shop:supplier:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listSupplier, getSupplier, delSupplier, addSupplier, updateSupplier } from "@/api/shop/supplier"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('shop/supplier/export', {
        ...this.queryParams
