...
<script>
import { listMember, getMember, delMember, addMember, updateMember } from "@/api/shop/member"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('shop/member/export', {
        ...this.queryParams
