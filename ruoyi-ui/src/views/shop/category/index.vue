    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['shop:category:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listCategory, getCategory, delCategory, addCategory, updateCategory } from "@/api/shop/category"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('shop/category/export', {
        ...this.queryParams
